...
class Werules_Chatbot_Model_Resource_Chatbotapi_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('werules_chatbot/chatbotapi_store')),
                'main_table.entity_id = store_table.chatbotapi_id',
                array()
            )
