...
class Edit extends \Werules\Chatbot\Controller\Adminhtml\PromotionalMessages
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('werules_chatbot_promotionalmessages', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Promotionalmessagess'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Promotionalmessages'));
        return $resultPage;
    }
}
